...
**Area**: security
**Tests**:
- `internal/httpapi/handlers_test.go` → "TestCSRFProtect_PostWithoutHeader_Returns403"
- `internal/httpapi/handlers_test.go` → "TestCSRFProtect_PostWithHeader_Succeeds"
- `internal/httpapi/handlers_test.go` → "TestCSRFProtect_GetWithoutHeader_Succeeds"
- `internal/httpapi/handlers_test.go` → "TestCSRFProtect_DeleteWithoutHeader_Returns403"
...
**Area**: security
**Tests**:
- `internal/httpapi/handlers_test.go` → "TestCSRFProtect_CrossOriginPost_Returns403"
- `internal/httpapi/handlers_test.go` → "TestCSRFProtect_SameOriginPost_Succeeds"
- `internal/httpapi/handlers_test.go` → "TestCSRFProtect_CrossOriginReferer_Returns403"
- `internal/httpapi/handlers_test.go` → "TestCSRFProtect_MalformedOrigin_Returns403"
